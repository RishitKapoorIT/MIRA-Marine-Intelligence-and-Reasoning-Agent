...
1. **Conversational Multi-Agent Reasoning**: Users ask natural questions in plain language (_"weather report of my area"_, _"where are the best fishing zones near Odisha"_, _"is it safe to sail today"_).
...
- **[LocationContext.jsx](file:///r:/SIH_2.0/orca-app/src/context/LocationContext.jsx)**:
  ...
  - Implements natural location parsing: queries like _"weather report of my area"_, _"how are waves here"_, or _"my place"_ automatically resolve to the user's active harbor without needing rigid syntax.
...
- **PFZ Marker System**:
  ...
  - Interactive popups displaying species, distance, SST, and a direct _"Plot Safe Route"_ button.
- **Camera Animations**:
...
2. **PFZ Attribution**: All PFZ cards and advisories state plainly: _"via ORCA's own PFZ model over public satellite data (not an INCOIS-certified advisory)"_.
